  ...
  return (
    <section className="relative min-h-screen pt-40 pb-28 px-8 md:px-16 lg:px-24">
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, rgba(15,18,14,0.62) 0%, rgba(15,18,14,0.52) 62%, rgba(15,18,14,0.18) 85%, transparent 100%)",
        }}
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-12 items-center mb-20 max-w-4xl">
        <div>
          <motion.h1
            className="display text-5xl md:text-6xl text-[#dfdbcc] leading-[0.9] mb-6 select-none"
          ...
          <motion.p
            className="text-[15px] font-light text-[#aeab99] leading-relaxed max-w-md"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="text-[10px] font-mono tracking-[0.3em] uppercase text-[#7c7a6d] mt-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
